...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post = new Post(null, fromDate("21/03/2018",fmt1), "Partiu viagem", "Vou viajar para São Paulo. Abraços!", maria);
        Post post2 = new Post(null, fromDate("23/03/2098",fmt1), "Bom dia", "Acordei feliz hoje!",maria);
